...
import PendingApplicationsIcon from "@/assets/svgs/admin/dashboard/in-progress-icon.svg?component";
import NewApplicationsIcon from "@/assets/svgs/admin/dashboard/new-icon.svg?component";
import FinishedApplicationsIcon from "@/assets/svgs/admin/dashboard/finished-icon.svg?component";
import AllApplicationsIcon from "@/assets/svgs/admin/dashboard/all-icon.svg?component";

...
import RedNetworkIcon from "@/assets/svgs/network/network-icon-red.svg?component";
import BlueNetworkIcon from "@/assets/svgs/network/network-icon-blue.svg?component";
import GreenNetworkIcon from "@/assets/svgs/network/network-icon-green.svg?component";

...
import IconCommon from "@/assets/svgs/services/services-icon-common.svg?component";
        ...
        {points.map((point) => (
          <button
            ...
            className="w-full flex justify-between items-center gap-[8px] p-[12px] bg-primaryWhite/10 rounded-[10px]
             ...
             text-left cursor-pointern action:transform active:scale-95 active:duration-75 cursor-pointer" // Added text-left
          >

...
import CheckedIcon from "@/assets/svgs/services/servicesPage/checked-icon.svg?component";
...
const OurServicesCard: React.FC<OurServicesCardProps> = ({
  ...
  const pathname = usePathname(); // e.g., "/services/internet"
  const serviceTitle = pathname.split("/").pop(); // e.g., "internet"
  return (
    <div
      className={cn(

...
const BASE_SECURITY_CONTENT = [Badge1.src, Badge2.src];
const BASE_TV_CONTENT = [Badge3.src, Badge4.src, Badge7.src];
const BASE_INTERNET_CONTENT = [Badge6.src, Badge5.src];

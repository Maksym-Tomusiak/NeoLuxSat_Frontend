    ...
    <>
      {isVisible && (
        <button
          ...
          className="pointer-events-auto float-right p-3 z-50 rounded-full bg-primaryOrange text-white shadow-lg transition-opacity duration-300 ease-in-out hover:bg-primaryOrange/80 focus:outline-none cursor-pointer flex items-center justify-center action:transform active:scale-95 active:duration-75" // <-- ADDED HERE

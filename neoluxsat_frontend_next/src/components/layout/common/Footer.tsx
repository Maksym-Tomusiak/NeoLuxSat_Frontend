...
const Footer = () => {
  return (
    <div className="h-[fit] xs:h-[600px] xl:h-[640px] max-md:mx-[16px] max-[1440px]:mx-[30px] min-[1440px]:w-[1380px] bg-primaryBlue min-w- max-w-[1380px] rounded-[20px] mx-auto px-[30px] py-[24px] flex flex-col justify-between mb-[16px] md:mb-[24px] blue-gradient-bg">

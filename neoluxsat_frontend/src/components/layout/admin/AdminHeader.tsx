import { useState, useEffect, Fragment } from 'react'; // 💡 --- UPDATED ---
import {
  Dialog,
  DialogPanel,
  Transition,
...
const AdminHeader = () => {
  ...
  // const [isClosing, setIsClosing] = useState(false); // 💡 --- REMOVE ---
  ...
  // 💡 --- REMOVE ---
  // This entire useEffect is no longer needed.
  // Headless UI <Dialog> handles scroll-locking automatically.
  /*
  useEffect(() => {
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-2000" onClose={handleClose}>
          ...
          <TransitionChild
            ...
            enterFrom="-translate-x-full" // Slide from left
            enterTo="translate-x-0"
            leave="transform transition ease-in-out duration-300"
            leaveFrom="translate-x-0"
            leaveTo="-translate-x-full" // Slide to left
          >
            {/* This <DialogPanel> replaces your old full-screen div.
              Animation classes are removed from here.
            */}
                    ...
                    <div className="flex flex-col gap-[24px]">
                      {crudsOptions.map((opt) => (
                        <a
                          ...
                          onClick={handleClose} // Keep this to close menu on nav
                        >
                          {opt.name}
                        </a>
                      ))}

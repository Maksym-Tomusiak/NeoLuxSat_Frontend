                ...
                <FormProvider {...methods}>
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-[24px] md:top-[30px] right-[24px] hover:text-gray-200 p-1 fill-primaryWhite/80 hover:fill-primaryWhite transition-colors cursor-pointer"
                      aria-label="Закрити"
                    >
                      <CloseIcon />
                    </button>

import ErrorIcon from '@/assets/svgs/network/checkmark-icon.svg';
...
const ErrorStatusCard: React.FC<{ data: ErrorPlaceholderProps }> = ({
  data,
}) => (
  <div className="w-full max-w-[680px] rounded-[20px] p-[24px] bg-primaryBlue/10  flex flex-col gap-[24px]">
    <div className="flex items-start gap-[24px]">
      <div className="rounded-[20px] flex items-center justify-center bg-primaryOrange p-[10px] max-xs:p-[8px] max-xs:rounded-[10px] max-xs:max-w-[40px] max-xs:max-h-[40px]">
        <ErrorIcon />
      </div>
